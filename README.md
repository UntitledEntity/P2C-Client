...
Download them [here](https://files.catbox.moe/qtx3kt.zip)
Place them into the main directory (along with all the other folders)
Extract them, then rename the folder to "Dependencies"
